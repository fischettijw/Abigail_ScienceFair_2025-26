...
VACCINATED_PERCENT = 0.80  # Proportion of the population that
...
while running:
    ...
    # Display legend
    pygame.draw.circle(screen, RED, (10, 55), 5.0)
    screen.blit(font.render("Infected", True, BLACK), (20, 45))

    pygame.draw.circle(screen, GREEN, (10, 70), 5.0)
    screen.blit(font.render("Immune", True, BLACK), (20, 65))

    pygame.draw.circle(screen, BLUE, (10, 90), 5.0)
    screen.blit(font.render("Susceptible", True, BLACK), (20, 85))

    pygame.draw.circle(screen, GRAY, (10, 110), 5.0)
